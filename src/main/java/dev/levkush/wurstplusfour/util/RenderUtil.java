...
public class RenderUtil implements Globals {
    ...
    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, Colour color, int alpha, int sides) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) WurstplusFour.GUI_FONT_MANAGER.getTextWidth(text) / 2.0), 0.0, 0.0);
        if (custom) {
            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        } else {
