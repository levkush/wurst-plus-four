package dev.levkush.wurstplusfour.command;

import dev.levkush.wurstplusfour.command.commands.BurrowBlockCommand;
...
public class Commands implements Globals {
    ...
    public Commands() {
        ...
        try {
            ArrayList<Class<?>> modClasses = ReflectionUtil.getClassesForPackage("dev.levkush.wurstplusfour.command.commands");
