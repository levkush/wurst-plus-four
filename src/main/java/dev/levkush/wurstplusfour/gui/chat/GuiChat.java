package dev.levkush.wurstplusfour.gui.chat;
...
import dev.levkush.wurstplusfour.util.AnimationUtil;
...
public class GuiChat extends GuiNewChat implements Globals {
    private static final Logger LOGGER = WurstplusFour.LOGGER;
                                ...
                                if (CustomChat.INSTANCE.smoothChat.getValue() && i1 <= newLines) {
                                    ...
                                    if (CustomChat.INSTANCE.rainbow.getValue()){
                                        if (CustomChat.INSTANCE.customFont.getValue()) {
                                            WurstplusFour.GUI_FONT_MANAGER.drawStringRainbow(s, 0.0f + (CustomChat.INSTANCE.type.is("Vertical") ? messageAdd : 0), (j2 - 8), true);
                                        } else {
                                        ...
                                        if (CustomChat.INSTANCE.customFont.getValue()) {
                                            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow(s, 0.0f + (CustomChat.INSTANCE.type.is("Vertical") ? messageAdd : 0), (j2 - 8), 16777215 + ((l1) << 24));
                                        } else {
                                    ...
                                    if (CustomChat.INSTANCE.rainbow.getValue()){
                                        if (CustomChat.INSTANCE.customFont.getValue()) {
                                            WurstplusFour.GUI_FONT_MANAGER.drawStringRainbow(s, 0.0f, (j2 - 8), true);
                                        } else {
                                            this.mc.fontRenderer.drawStringWithShadow(s, 0.0f, (j2 - 8), Rainbow.getColour().getRGB());
                                        }
                                    } else {
                                        if (CustomChat.INSTANCE.customFont.getValue()) {
                                            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow(s, i2, (j2 - 8), 16777215 + (l1 << 24));
                                        } else {
