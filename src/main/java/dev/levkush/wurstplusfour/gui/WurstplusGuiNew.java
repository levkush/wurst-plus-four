...
public class WurstplusGuiNew extends GuiScreen {
    ...
    public WurstplusGuiNew() {
        ...
        int startX = 10;
        for (Hack.Category category : WurstplusFour.HACKS.getCategories()) {
    ...
    public void onGuiClosed() {
        WurstplusFour.CONFIG_MANAGER.saveConfig();
    ...
    private void animate(ScaledResolution sr){
        final int deltaTime = WurstplusFour.RENDER_UTIL_2D.getDeltaTime();
        for(CategoryComponent c : categoryComponents) {
