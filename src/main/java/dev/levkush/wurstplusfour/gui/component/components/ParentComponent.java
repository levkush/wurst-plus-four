...
public class ParentComponent extends Component {
    ...
    public void renderComponent(int mouseX, int mouseY) {
        ...
        if (Gui.INSTANCE.customFont.getValue()) {
            ...
            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow((this.option.getValue() ? "-" : "+"), parent.parent.getX() + 90 + WurstplusGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + WurstplusGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        } else {
