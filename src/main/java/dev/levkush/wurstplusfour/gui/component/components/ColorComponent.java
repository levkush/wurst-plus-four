...
import dev.levkush.wurstplusfour.event.events.ColorCopyEvent;
...
public class ColorComponent extends Component {
    ...
    public void renderComponent(int mouseX, int mouseY) {
        ...
        if (Gui.INSTANCE.customFont.getValue()) {
            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow(set.getName(), parent.parent.getX() + WurstplusGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + WurstplusGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        } else {
        ...
        if (this.isOpen) {
            ...
            if (Gui.INSTANCE.customFont.getValue()) {
                WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow("Rainbow", parent.parent.getX() + WurstplusGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 5  + WurstplusGuiNew.MODULE_OFFSET + booleanButtonOffset , Gui.INSTANCE.fontColor.getValue().hashCode());
            } else {
    ...
    public void renderToolTip(int mouseX, int mouseY){
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && Gui.INSTANCE.toolTips.getValue()){
            ...
            int length = WurstplusFour.GUI_FONT_MANAGER.getTextWidth(text);
            ...
            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow(text, mouseX + 3, mouseY + 8, new Color(255,255,255).hashCode());
        }
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && button == 0){
            WurstplusFour.GUI2.colorClipBoard = set.getValue();
        ...
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && button == 2){
            this.set.setValue(WurstplusFour.GUI2.colorClipBoard);
