package dev.levkush.wurstplusfour.gui.hud.element;
...
public class HudDragComponent extends Component {
    ...
    public void updateComponent(int mouseX, int mouseY) {
        ...
        if (this.dragging){
            ...
            double size = WurstplusFour.GUI_FONT_MANAGER.getTextWidth("X: " + this.element.getX() + ", Y: " + this.element.getY());
            ...
            WurstplusFour.GUI_FONT_MANAGER.drawStringWithShadow("X: " + this.element.getX() + ", Y: " + this.element.getY(), Math.round(this.element.getX() / 0.7) , Math.round(this.element.getY() / 0.7) - 12, new Color(255,255,255).hashCode());
            GL11.glPopMatrix();
        }
    }
